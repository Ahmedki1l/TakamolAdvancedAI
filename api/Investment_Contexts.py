...
simplified_investment_context = """
                            ...
                            يجب عليك أن توفر البيانات المطلوبة بصيغة json فقط كالآتي:
                            {
                                ...
                                "تكلفة_البناء_لكل_متر_مربع": (اقترح تكلفة لا تقل عن 1700 ريال سعودي ),
                                "الأدوار":"اقترح عددا للأدوار هنا بناءا على التخطيطات الهندسية في المكان و متوسط عدد الادوار للعمارات في هذه المنطقة."
                                "حجم_الوحدات": (اقترح رقم لحجم للوحدات الإدارية هنا) 
                                "تقييم_المخاطر": {
                                    "تقلبات_السوق": "متوسطة - يواجه سوق العقارات في الرياض تقلبات دورية.",
                                    "التغييرات_التنظيمية": "مخاطر منخفضة - بيئة تنظيمية مستقرة مع توقعات بتغييرات طفيفة.",
                                    "العوامل_الاقتصادية": "عالية - قد تؤثر التنويع الاقتصادي والاستثمار العام بشكل كبير على قيم العقارات."
