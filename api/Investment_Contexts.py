                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                            ...
                                            "مجموع_تكاليف_البناء": "نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_لكل_متر_مربع = 3600 * 1400",
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                            ...
                                            "مجموع_تكاليف_البناء": "نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_لكل_متر_مربع = 3,500 * 1,400",
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            ...
                                            "النفقات_التشغيلية": "20% من الإيجار_السنوي_الكلي = النتيجة هنا",
