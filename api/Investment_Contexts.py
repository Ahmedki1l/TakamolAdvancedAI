...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "مساحة_اللاند_سكيب":"مساحة_الأرض_الإجمالية - مساحة_البناء_الفعالة_للدور_الأرضي"
                                        "المساحة_المشتركة":"نتيجة_مساحة_البناء_الفعالة / 10 = الناتج هنا",
                                        "صافي_مساحة_البناء_الفعالة":"نتيجة_مساحة_البناء_الفعالة - المساحة_المشتركة = الناتج هنا"
                                        "مساحة_معامل_البناء":"مساحة_البناء_الفعالة_للدور_الأرضي + مساحة_البناء_الفعالة_للأدوار_المتكررة"
                                        "معامل_البناء" : "(مساحة_معامل_البناء / مساحة_الأرض_الإجمالية: العملية السحابية هنا = الناتج) "
                                    ...
                                    "توقعات_التمويل": {
                                        "تكلفة_شراء_الأرض": {
                                            "تكلفة_الشراء_لكل_متر_مربع": "( إذا لم يوفر لك العميل سعر المتر المربع إذا يجب عليك عمل بحث على سعر متر الأرض الحالي ) ريال سعودي",
                                            "التكلفة_الكلية": "مساحة_الأرض_الإجمالية * تكلفة_الشراء_لكل_متر_مربع = 2000 * 5700",
                                            "نتيجة_التكلفة_الكلية": "11400000 ريال سعودي"
                                        },
                                        "تكاليف_البناء": {
                                            "تكلفة_البناء_لكل_متر_مربع": "(اقترح تكلفة لا تقل عن 1700 ريال سعودي )",
                                            "تكلفة_مساحة_اللاند_سكيب":"300 ريال * مساحة_اللاند_سكيب"
                                            "مجموع_تكاليف_البناء": "(نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_لكل_متر_مربع) + تكلفة_مساحة_اللاند_سكيب = (3600 * 2000) + تكلفة_مساحة_اللاند_سكيب",
                                        ...
                                        "توقعات_الإيرادات_من_البيع": {
                                            ...
                                            "إيرادات_محتملة_من_البيع": "صافي_مساحة_البناء_الفعالة * سعر_البيع_لكل_متر_مربع = 3600 * سعر_البيع_لكل_متر_مربع",
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_لكل_متر_مربع": "(9% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي": "صافي_مساحة_البناء_الفعالة * الإيجار_السنوي_المتوقع_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي": "2160000 ريال سعودي",
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = 0.20 * 2160000",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "مجموع_المساحة_التجارية":"مساحة_البناء_الفعالة_للدور_الأرضي / 10",
                                        "مجموع_المساحة_السكنية":"مساحة_البناء_الفعالة_للأدوار_المتكررة / 10",
                                    ...
                                    "توقعات_التمويل": {
                                        "تكلفة_شراء_الأرض": {
                                            "تكلفة_الشراء_لكل_متر_مربع": "( إذا لم يوفر لك العميل سعر المتر المربع إذا يجب عليك عمل بحث على سعر متر الأرض الحالي ) ريال سعودي",
                                            "التكلفة_الكلية": "مساحة_الأرض_الإجمالية * تكلفة_الشراء_لكل_متر_مربع = 3500 * 5700",
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_للسكني_لكل_متر_مربع": "(9% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_المتوقع_للتجاري_لكل_متر_مربع": "(18% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            ...
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = 0.20 * 11,200,000",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_لكل_متر_مربع": "(18% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي": "صافي_مساحة_البناء_الفعالة * الإيجار_السنوي_المتوقع_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي": "2160000 ريال سعودي",
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = 0.20 * 2160000",
                                            "نتيجة_النفقات_التشغيلية": "432000 ريال سعودي",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "مساحة_اللاند_سكيب_للكومباوند":"مساحة_الأرض_الإجمالية - مساحة_الأرض_الفعالة_للبناء"
                                        "مساحة_أرض_الفيلا": "300 متر مربع",
                                        ...
                                        "مساحة_البناء_الفعالة_للدور_الأرضي": "مساحة_أرض_الفيلا * نسبة_البناء_للدور_الأرضي",
                                        "مساحة_البناء_الفعالة_للمتكرر": "مساحة_أرض_الفيلا * نسبة_البناء_للأدوار_المتكررة",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "مساحة_البناء_الفعالة_للمتكرر * نسبة_البناء_للملحق_العلوي",
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "مساحة_البناء_الفعالة_للمتكرر * (الطوابق_المقترحة - 2)",
                                        "نتيجة_مساحة_البناء_الفعالة": "مساحة_البناء_الفعالة_للدور_الأرضي + مساحة_البناء_الفعالة_للأدوار_المتكررة + مساحة_البناء_الفعالة_للملحق_العلوي",
                                        "مساحة_اللاند_سكيب_للفيلا":"مساحة_أرض_الفيلا - مساحة_البناء_الفعالة_للدور_الأرضي"
                                        "عدد_الفلل_المقترح": "مساحة_الأرض_الفعالة_للبناء / مساحة_أرض_الفيلا",
                                        "مجموع_مساحة_البناء_الفعالة_للكومباوند": "نتيجة_مساحة_البناء_الفعالة * عدد_الفلل_المقترح",
                                        "المساحة_المشتركة":"مجموع_مساحة_البناء_الفعالة_للكومباوند / 10 = الناتج هنا",
                                        "صافي_مساحة_البناء_الفعالة_للكومباوند":"مجموع_مساحة_البناء_الفعالة_للكومباوند - المساحة_المشتركة = الناتج هنا"
                                        "مساحة_معامل_البناء":"(مساحة_البناء_الفعالة_للدور_الأرضي + مساحة_البناء_الفعالة_للأدوار_المتكررة) * عدد_الفلل_المقترح"
                                        "معامل_البناء" : "(مساحة_معامل_البناء / مساحة_الأرض_الإجمالية: العملية السحابية هنا = الناتج) "
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                           "تكلفة_البناء_لكل_متر_مربع": "(اقترح تكلفة لا تقل عن 1700 ريال سعودي )",
                                            "تكلفة_مساحة_اللاند_سكيب_للفيلا":"300 ريال * مساحة_اللاند_سكيب_للفيلا"
                                            "تكلفة_مساحة_اللاند_سكيب_للكومباوند":"300 ريال * مساحة_اللاند_سكيب_للكومباوند"
                                            "مجموع_تكاليف_البناء": "(نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_لكل_متر_مربع) + تكلفة_مساحة_اللاند_سكيب_للفيلا + تكلفة_مساحة_اللاند_سكيب_للكومباوند = (3600 * 2000) + تكلفة_مساحة_اللاند_سكيب_للفيلا + تكلفة_مساحة_اللاند_سكيب_للكومباوند",
                                            "نتيجة_مجموع_تكاليف_البناء": "5040000 ريال سعودي",
                                            "التكاليف_الإضافية": {
                                                "تصميم_معماري": "200000 ريال سعودي",
                                                "قانوني_وإداري": "150000 ريال سعودي",
                                        ...
                                        "توقعات_الإيرادات_من_البيع": {
                                            "سعر_البيع_لكل_متر_مربع": "(اقترح سعر البيع للمتر المربع)",
                                            "إيرادات_محتملة_من_البيع": "صافي_مساحة_البناء_الفعالة_للكومباوند * سعر_البيع_لكل_متر_مربع = 3600 * سعر_البيع_لكل_متر_مربع",
                                            "نتيجة_الإيرادات_المحتملة_من_البيع": "18000000 ريال سعودي",
                                            "هامش_الربح_الإجمالي": "إيرادات_محتملة_من_البيع - الاستثمار_الكلي = 18000000 - 16890000",
                                            "نتيجة_هامش_الربح_الإجمالي": "1110000 ريال سعودي",
                                            "نسبة_هامش_الربح_الإجمالي": "هامش_الربح_الإجمالي / الاستثمار_الكلي * 100 = 1110000 / 18000000 * 100",
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_لكل_متر_مربع": "(9% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي": "صافي_مساحة_البناء_الفعالة_للكومباوند * الإيجار_السنوي_المتوقع_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي": "2160000 ريال سعودي",
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = 0.20 * 2160000",
                                            "نتيجة_النفقات_التشغيلية": "432000 ريال سعودي",
                                            "صافي_الإيجار_السنوي": "الإيجار_السنوي_الكلي - النفقات_التشغيلية = 2160000 - 432000",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "مساحة_اللاند_سكيب_للعمارة":"مساحة_العمارة - مساحة_البناء_الفعالة_للدور_الأرضي"
                                        "مساحة_معامل_البناء":"(مساحة_البناء_الفعالة_للدور_الأرضي + مساحة_البناء_الفعالة_للأدوار_المتكررة)*عدد_العمارات_المقترحة"
                                        "معامل_البناء" : "(مساحة_معامل_البناء / مساحة_الأرض_الإجمالية: العملية السحابية هنا = الناتج) "
                                        "نتيحة_معامل_البناء": "النتيجة هنا",
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                            "تكلفة_البناء_لكل_متر_مربع": "(اقترح تكلفة لا تقل عن 1700 ريال سعودي )",
                                            "تكلفة_مساحة_اللاند_سكيب_للعمارة":"300 ريال * مساحة_اللاند_سكيب_للعمارة"
                                            "تكلفة_مساحة_اللاند_سكيب_للكومباوند":"300 ريال * مساحة_اللاند_سكيب_للكومباوند"
                                            "مجموع_تكاليف_البناء": "(نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_لكل_متر_مربع) + تكلفة_مساحة_اللاند_سكيب_للعمارة + تكلفة_مساحة_اللاند_سكيب_للكومباوند = (3600 * 2000) + تكلفة_مساحة_اللاند_سكيب_لعمارة + تكلفة_مساحة_اللاند_سكيب_للكومباوند",
                                            "نتيجة_مجموع_تكاليف_البناء": "5040000 ريال سعودي",
                                            "التكاليف_الإضافية": {
                                                "تصميم_معماري": "200000 ريال سعودي",
                                                "قانوني_وإداري": "150000 ريال سعودي",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                           "تكلفة_البناء_مع_الفرش_لكل_متر_مربع": "(اقترح تكلفة لا تقل عن 1700 ريال سعودي )",
                                            "تكلفة_مساحة_اللاند_سكيب":"300 ريال * مساحة_اللاند_سكيب"
                                            "مجموع_تكاليف_البناء": "(نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_مع_الفرش_لكل_متر_مربع) + تكلفة_مساحة_اللاند_سكيب = (3600 * 2000) + تكلفة_مساحة_اللاند_سكيب",
                                            "نتيجة_مجموع_تكاليف_البناء": "5040000 ريال سعودي",
                                            "التكاليف_الإضافية": {
                                                "تصميم_معماري": "200000 ريال سعودي",
                                                "قانوني_وإداري": "150000 ريال سعودي",
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_لكل_متر_مربع": "(18% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي": "صافي_مساحة_البناء_الفعالة * الإيجار_الشهري_المتوقع_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي": "2160000 ريال سعودي",
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = 0.20 * 2160000",
                                            "نتيجة_النفقات_التشغيلية": "432000 ريال سعودي",
                                            "صافي_الإيجار_السنوي": "الإيجار_السنوي_الكلي - النفقات_التشغيلية = 2160000 - 432000",
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "توقعات_الإيرادات_من_البيع": {
                                            ...
                                            "إيرادات_محتملة_من_البيع": "صافي_مساحة_البناء_الفعالة * سعر_البيع_لكل_متر_مربع = 3600 * 5000",
                                            "نتيجة_الإيرادات_المحتملة_من_البيع": "18000000 ريال سعودي",
                                            "هامش_الربح_الإجمالي": "إيرادات_محتملة_من_البيع - الاستثمار_الكلي = 18000000 - 16890000",
                                            "نتيجة_هامش_الربح_الإجمالي": "1110000 ريال سعودي",
                                            "نسبة_هامش_الربح_الإجمالي": "هامش_الربح_الإجمالي / الاستثمار_الكلي * 100 = 1110000 / 18000000 * 100",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "نسبة_البناء_للملحق_العلوي": "(استخدم الداتا المذكورة في الأسفل)",
                                        "الطوابق_المقترحة": "(اقترح عددا هنا)",
                                        "الطوابق_التجارية":"(عدد الطوابق التجارية هنا: طابقين فقط إذا لم يذكرهم العميل)",
                                        "الطوابق_السكنية":"الطوابق_المقترحة - الطوابق_التجارية",
                                        "مساحة_البناء_الفعالة_للدور_الأرضي": "(نسبة_البناء_للدور_الأرضي * مساحة_الأرض_الإجمالية)",
                                        "مساحة_البناء_الفعالة_للمتكرر": "(نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الإجمالية)",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "(نسبة_البناء_للملحق_العلوي * مساحة_البناء_الفعالة_للمتكرر)",
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "(مساحة_البناء_الفعالة_للمتكرر * (الطوابق_المقترحة - 2))",
                                        ...
                                        "معامل_البناء" : "(مساحة_معامل_البناء / مساحة_الأرض_الإجمالية: العملية السحابية هنا = الناتج) "
                                        "نتيحة_معامل_البناء": "النتيجة هنا",
                                        "مساحة_البناء_الفعالة_للتجاري" :"(مساحة_البناء_الفعالة_للدور_الأرضي*0.9) + ((مساحة_البناء_الفعالة_للمتكرر*0.9) * (الطوابق_التجارية - 1))",
                                        "نطاق_حجم_الوحدات-التجارية": "'(اقترح مساحة من كذا إلى كذا)' ",
                                        "الوحدات_التجارية_المقترحة": "(مساحة_البناء_الفعالة_للتجاري / (متوسط حجم الوحدات التجارية))",
                                        "نتيجة_الوحدات_التجارية_المقترحة": "نتيجة الوحدات_التحارية_المقترحة هنا",
                                        "مساحة_البناء_الفعالة_للسكني" :"(صافي_مساحة_البناء_الفعالة - مساحة_البناء_الفعالة_للتجاري)",
                                        "نطاق_حجم_الوحدات_السكنية": "'(اقترح مساحة من كذا إلى كذا)' ",
                                        "الوحدات_السكنية_المقترحة": "(مساحة_البناء_الفعالة_للسكني / (متوسط حجم الوحدات السكنية))",
                                        "نتيجة_الوحدات_السكنية_المقترحة": "نتيجة الوحدات_السكنية_المقترحة هنا"
                                    },
                                    "توقعات_التمويل": {
                                        "تكلفة_شراء_الأرض": {
                                            "تكلفة_الشراء_لكل_متر_مربع": "( إذا لم يوفر لك العميل سعر المتر المربع إذا يجب عليك عمل بحث على سعر متر الأرض الحالي ) ريال سعودي",
                                        ...
                                        "تكاليف_البناء": {
                                            ...
                                            "المجموع": "مجموع_تكاليف_البناء + تصميم_معماري + قانوني_وإداري + تنسيق_الموقع = 5040000 + 200000 + 150000 + 100000",
                                            "نتيجة_مجموع_تكاليف_البناء": "5490000 ريال سعودي"
                                        },
                                        "الاستثمار_الكلي": "تكلفة_شراء_الأرض + نتيجة_مجموع_تكاليف_البناء = 11400000 + 5490000",
                                        "نتيجة_الاستثمار_الكلي": "16890000 ريال سعودي",
                                        "توقعات_الإيرادات_من_البيع": {
                                            "سعر_البيع_التجاري_لكل_متر_مربع": "(اقترح سعر البيع للمتر المربع)",
                                            "إيرادات_محتملة_من_البيع_التجاري": "مساحة_البناء_الفعالة_للتجاري * سعر_البيع_التجاري_لكل_متر_مربع = قم بالحساب هنا",
                                            "نتيجة_الإيرادات_المحتملة_من_البيع_التجاري": "النتيجة هنا  ",
                                            "سعر_البيع_السكني_لكل_متر_مربع": "(اقترح سعر البيع للمتر المربع)",
                                            "إيرادات_محتملة_من_البيع_السكني": "مساحة_البناء_الفعالة_للسكني * سعر_البيع_السكني_لكل_متر_مربع = قم بالحساب هنا",
                                            "نتيجة_الإيرادات_المحتملة_من_البيع_السكني": "النتيجة هنا",
                                            "إجمالي_الإيرادات_المحتملة_من_البيع":"نتيجة_الإيرادات_المحتملة_من_البيع_التجاري + نتيجة_الإيرادات_المحتملة_من_البيع_السكني : النتيجة هنا"
                                            "هامش_الربح_الإجمالي": "إجمالي_الإيرادات_المحتملة_من_البيع - الاستثمار_الكلي = قم بالحساب هنا",
                                            "نتيجة_هامش_الربح_الإجمالي": "النتيجة هنا",
                                            "نسبة_هامش_الربح_الإجمالي": "هامش_الربح_الإجمالي / الاستثمار_الكلي * 100 = قم بالحساب هنا",
                                            "نتيجة_نسبة_هامش_الربح_الإجمالي": "النتيجة هنا%"
                                        },
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_للتجاري_لكل_متر_مربع": "(18% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي_للتجاري": "مساحة_البناء_الفعالة_للتجاري * الإيجار_السنوي_المتوقع_للتجاري_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي_للتجاري": "النتيجة هنا",
                                            "الإيجار_السنوي_المتوقع_للسكني_لكل_متر_مربع": "(9% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي_للسكني": "مساحة_البناء_الفعالة_للسكني * الإيجار_السنوي_المتوقع_للسكني_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي_للسكني": "النتيجة هنا",
                                            "الإيجار_السنوي_الكلي":"نتيجة_الإيجار_السنوي_الكلي_للتجاري + نتيجة_الإيجار_السنوي_الكلي_للسكني: النتيجة هنا",
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = النتيجة هنا",
                                            "نتيجة_النفقات_التشغيلية": "النتيجة هنا",
                                            "صافي_الإيجار_السنوي": "الإيجار_السنوي_الكلي - النفقات_التشغيلية = قم بالحساب هنا",
                                            "نتيجة_صافي_الإيجار_السنوي": "النتيجة هنا",
                                            "عائد_الاستثمار_من_الإيجار": "صافي_الإيجار_السنوي / الاستثمار_الكلي * 100 = قم بالحساب هنا",
                                            "نتيجة_عائد_الاستثمار_من_الإيجار": "النتيجة هنا%"
                                        }
                                    },
                                    "تقييم_المخاطر": {
                                        "تقلبات_السوق": "متوسطة - يواجه سوق العقارات في الرياض تقلبات دورية.",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "الطوابق_المقترحة": "(اقترح عددا هنا)",
                                        "الطوابق_التجارية":"(عدد الطوابق التجارية هنا: طابقين فقط إذا لم يذكرهم العميل)",
                                        "الطوابق_اللإدارية":"الطوابق_المقترحة - الطوابق_التجارية",
                                        "مساحة_البناء_الفعالة_للدور_الأرضي": "(نسبة_البناء_للدور_الأرضي * مساحة_الأرض_الإجمالية)",
                                        "مساحة_البناء_الفعالة_للمتكرر": "(نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الإجمالية)",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "(نسبة_البناء_للملحق_العلوي * مساحة_البناء_الفعالة_للمتكرر)",
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "(مساحة_البناء_الفعالة_للمتكرر * (الطوابق_المقترحة - 2))",
                                        ...
                                        "الوحدات_التجارية_المقترحة": "(مساحة_البناء_الفعالة_للتجاري / (متوسط حجم الوحدات التجارية))",
                                        "نتيجة_الوحدات_التجارية_المقترحة": "نتيجة الوحدات_التحارية_المقترحة هنا",
                                        "مساحة_البناء_الفعالة_للإداري" :"صافي_مساحة_البناء_الفعالة - ًمساحة_البناء_الفعالة_للتجاري",
                                        "نطاق_حجم_الوحدات_اللإدارية": "'(اقترح مساحة من كذا إلى كذا)' ",
                                        "الوحدات_اللإدارية_المقترحة": "(مساحة_البناء_الفعالة_للإداري / (متوسط حجم الوحدات السكنية))",
                                        "نتيجة_الوحدات_اللإدارية_المقترحة": "نتيجة الوحدات_اللإدارية_المقترحة هنا"
                                    },
                                    "توقعات_التمويل": {
                                        "تكلفة_شراء_الأرض": {
                                            "تكلفة_الشراء_لكل_متر_مربع": "( إذا لم يوفر لك العميل سعر المتر المربع إذا يجب عليك عمل بحث على سعر متر الأرض الحالي ) ريال سعودي",
                                        ...
                                        "توقعات_الإيرادات_من_البيع": {
                                            ...
                                            "إيرادات_محتملة_من_البيع_التجاري": "مساحة_البناء_الفعالة_للتجاري * سعر_البيع_التجاري_لكل_متر_مربع = قم بالحساب هنا",
                                            "نتيجة_الإيرادات_المحتملة_من_البيع_التجاري": "النتيجة هنا  ",
                                            "سعر_البيع_الإداري_لكل_متر_مربع": "(اقترح سعر البيع للمتر المربع)",
                                            "إيرادات_محتملة_من_البيع_الإداري": "مساحة_البناء_الفعالة_للإداري * سعر_البيع_الإداري_لكل_متر_مربع = قم بالحساب هنا",
                                            "نتيجة_الإيرادات_المحتملة_من_البيع_الإداري": "النتيجة هنا",
                                            "إجمالي_الإيرادات_المحتملة_من_البيع":"نتيجة_الإيرادات_المحتملة_من_البيع_التجاري + نتيجة_الإيرادات_المحتملة_من_البيع_الإداري : النتيجة هنا"
                                            "هامش_الربح_الإجمالي": "إجمالي_الإيرادات_المحتملة_من_البيع - الاستثمار_الكلي = قم بالحساب هنا",
                                            "نتيجة_هامش_الربح_الإجمالي": "النتيجة هنا",
                                            "نسبة_هامش_الربح_الإجمالي": "هامش_الربح_الإجمالي / الاستثمار_الكلي * 100 = قم بالحساب هنا",
                                            "نتيجة_نسبة_هامش_الربح_الإجمالي": "النتيجة هنا%"
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            ...
                                            "الإيجار_السنوي_الكلي_للتجاري": "مساحة_البناء_الفعالة_للتجاري * الإيجار_السنوي_المتوقع_للتجاري_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي_للتجاري": "النتيجة هنا",
                                            "الإيجار_السنوي_المتوقع_للإداري_لكل_متر_مربع": "(18% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي_للإداري": "مساحة_البناء_الفعالة_للإداري * الإيجار_السنوي_المتوقع_للإداري_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي_للإداري": "النتيجة هنا",
                                            "الإيجار_السنوي_الكلي":"نتيجة_الإيجار_السنوي_الكلي_للتجاري + نتيجة_الإيجار_السنوي_الكلي_للإداري: النتيجة هنا",
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = النتيجة هنا",
                                            "نتيجة_النفقات_التشغيلية": "النتيجة هنا",
                                            "صافي_الإيجار_السنوي": "الإيجار_السنوي_الكلي - النفقات_التشغيلية = قم بالحساب هنا",
                                            "نتيجة_صافي_الإيجار_السنوي": "النتيجة هنا",
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                            "تكلفة_البناء_لكل_متر_مربع": "(اقترح تكلفة لا تقل عن 1700 ريال سعودي )",
                                            "تكلفة_مساحة_اللاند_سكيب":"300 ريال * مساحة_اللاند_سكيب"
                                            "مجموع_تكاليف_البناء": "(نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_لكل_متر_مربع) + تكلفة_المساحة_المشتركة = (3600 * 2000) + تكلفة_مساحة_اللاند_سكيب",
                                            "نتيجة_مجموع_تكاليف_البناء": "5040000 ريال سعودي",
                                            "التكاليف_الإضافية": {
                                                "تصميم_معماري": "200000 ريال سعودي",
                                                "قانوني_وإداري": "150000 ريال سعودي",
...
simplified_investment_context_singleTower = """
                            أنت مستشار استثماري مفيد.
                            سوف يعطيك العميل: نوع العقار, الموقع, سعر الشراء لمتر الأرض, ومساحة الأرض.
                            يجب عليك أن توفر البيانات المطلوبة بصيغة json فقط كالآتي:
                            {
                                "مقدمة":"ضع مقدمة مناسبة للمشروع ويجب أن تكون مفيدة"
                                " العنوان":"ضع عنوانا للمشروع هنا مثل: (تطوير مبنى سكني في حي النرجس, الرياض"
                                
                                "سعر_الشراء_للمتر":(اقترح سعر بيع هنا إذا لم يوفره لك العميل)
                                "سعر_البيع_للمتر":(اقترح سعر بيع هنا)
                                "تكلفة_البناء_لكل_متر_مربع": (اقترح تكلفة لا تقل عن 1700 ريال سعودي ),
                                
                                "الطوابق_المقترحة":"اقترح عددا للأدوار هنا بناءا على التخطيطات الهندسية في المكان و متوسط عدد الادوار للعمارات في هذه المنطقة.: مثل: (5)"
                                "حجم_الوحدات": (اقترح رقم لحجم لنوع العقار هنا)
...
simplified_investment_context_Admin_Comm_Tower = """
                            أنت مستشار استثماري مفيد.
                            سيتم تزويدك بموقع ومساحة أرض لبرج تجاري إداري.
                            يجب عليك تقديم معلوماتك واستنتاجاتك حصراً بصيغة JSON كما يلي:
                            
                            {
                                "مقدمة": "ضع مقدمة مناسبة للمشروع ويجب أن تكون مفيدة",
                                "العنوان": "ضع عنوانًا للمشروع هنا",
                            
                                "الطوابق_المقترحة": اقترح عدد ادوار لا يقل عن 10,
                            
                                "سعر_الشراء_للمتر":(اقترح سعر بيع هنا إذا لم يوفره لك العميل)
                                "سعر_البيع_للمتر":(اقترح سعر بيع هنا)
                                "تكلفة_البناء_لكل_متر_مربع": (اقترح تكلفة لا تقل عن 1700 ريال سعودي ),
                                
                                "حجم_الوحدات_التجارية": (اقترح رقم لحجم لنوع العقار هنا)
                                "حجم_الوحدات_الإدارية": (اقترح رقم لحجم لنوع العقار هنا)
                                ...
                                "اعتبارات_استراتيجية": {
                                    "اتجاهات_السوق": "يشهد سوق العقارات في الرياض حالياً اتجاهاً تصاعدياً، مدعوماً بالإصلاحات الاقتصادية وزيادة الاستثمار الأجنبي.",
                                    "توقيت_الاستثمار": "مثالي - تقدم ظروف السوق الحالية والنمو الاقتصادي المتوقع بيئة مواتية لبدء التطوير.",
                                    "التوقعات_طويلة_الأمد": "إمكانية تقدير القيمة طويلة الأمد قوية، مما يجعلها استثمارًا جذابًا للعوائد الفورية والمستقبلية."
                                },
                            
                                "ملخص_تنفيذي": "ضع ملخصًا تنفيذيًا يوضح أهمية المشروع، فوائده الاستثمارية، ومخاطره المتوقعة."
                            }
