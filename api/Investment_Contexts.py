...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "معامل_البناء" : "(نتيجة_مساحة_البناء_الفعالة / مساحة_الأرض_الإجمالية: العملية السحابية هنا = الناتج) ",
                                        "نتيحة_معامل_البناء": "النتيجة هنا",
                                        "مساحة_البناء_الفعالة_للتجاري" :"قم بحساب مساحة بناء الادوار التجارية ابتداءا من الدور الارضي",
                                        "نطاق_حجم_الوحدات-التجارية": "'(اقترح مساحة من كذا إلى كذا)' ",
                                        "الوحدات_التجارية_المقترحة": "(مساحة_البناء_الفعالة_للتجاري / (متوسط حجم الوحدات التجارية))",
                                        "نتيجة_الوحدات_التجارية_المقترحة": "نتيجة الوحدات_التحارية_المقترحة هنا",
                                        "مساحة_البناء_الفعالة_للسكني" :"قم بحساب مساحة بناء الادوار السكنية ابتداءا من الدور الذي يلي الادوار التجارية مباشرةً",
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            ...
                                            "الإيجار_السنوي_الكلي_للتجاري": "مساحة_البناء_الفعالة_للتجاري * الإيجار_السنوي_المتوقع_للتجاري_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي_للتجاري": "النتيجة هنا",
                                            "الإيجار_السنوي_المتوقع_للإداري_لكل_متر_مربع": "(18% من تكلفة_لكل_متر_مربع) ريال سعودي",
