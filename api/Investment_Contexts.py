...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "المساحة_المشتركة":"مساحة_الأرض_الإجمالية - مساحة_البناء_الفعالة_للدور_الأرضي"
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                            ...
                                            "تكلفة_المساحة_المشتركة":"300 ريال * المساحة_المشتركة"
                                            "مجموع_تكاليف_البناء": "(نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_لكل_متر_مربع) + تكلفة_المساحة_المشتركة = (3600 * 2000) + تكلفة_المساحة_المشتركة",
                                        ...
                                        "توقعات_الإيرادات_من_البيع": {
                                            ...
                                            "إيرادات_محتملة_من_البيع": "نتيجة_مساحة_البناء_الفعالة * سعر_البيع_لكل_متر_مربع = 3600 * سعر_البيع_لكل_متر_مربع",
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            ...
                                            "الإيجار_السنوي_الكلي": "نتيجة_مساحة_البناء_الفعالة * الإيجار_السنوي_المتوقع_لكل_متر_مربع = ( قم بحساب العملية )",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "المساحة_المشتركة_للكومباوند":"مساحة_الأرض_الإجمالية - مساحة_الأرض_الفعالة_للبناء"
                                        ...
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "مساحة_البناء_الفعالة_للمتكرر * (الطوابق_المقترحة - 2)",
                                        "نتيجة_مساحة_البناء_الفعالة": "مساحة_البناء_الفعالة_للدور_الأرضي + مساحة_البناء_الفعالة_للأدوار_المتكررة + مساحة_البناء_الفعالة_للملحق_العلوي",
                                        "المساحة_المشتركة_للفيلا":"مساحة_أرض_الفيلا - مساحة_البناء_الفعالة_للدور_الأرضي"
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "المساحة_المشتركة_للعمارة":"مساحة_العمارة - مساحة_البناء_الفعالة_للدور_الأرضي"
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "تكاليف_البناء": {
                                           "تكلفة_البناء_مع_الفرش_لكل_متر_مربع": "(اقترح تكلفة لا تقل عن 1700 ريال سعودي )",
                                            "تكلفة_المساحة_المشتركة":"300 ريال * المساحة_المشتركة"
                                            "مجموع_تكاليف_البناء": "(نتيجة_مساحة_البناء_الفعالة * تكلفة_البناء_مع_الفرش_لكل_متر_مربع) + تكلفة_المساحة_المشتركة = (3600 * 2000) + تكلفة_المساحة_المشتركة",
                                            "نتيجة_مجموع_تكاليف_البناء": "5040000 ريال سعودي",
                                            "التكاليف_الإضافية": {
                                                "تصميم_معماري": "200000 ريال سعودي",
                                                "قانوني_وإداري": "150000 ريال سعودي",
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_لكل_متر_مربع": "(18% من تكلفة_الشراء_لكل_متر_مربع) ريال سعودي",
                                            "الإيجار_السنوي_الكلي": "نتيجة_مساحة_البناء_الفعالة * الإيجار_الشهري_المتوقع_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي": "2160000 ريال سعودي",
                                            "النفقات_التشغيلية": "5% من الإيجار_السنوي_الكلي = 0.20 * 2160000",
                                            "نتيجة_النفقات_التشغيلية": "432000 ريال سعودي",
                                            "صافي_الإيجار_السنوي": "الإيجار_السنوي_الكلي - النفقات_التشغيلية = 2160000 - 432000",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "معامل_البناء" : "(مساحة_معامل_البناء / مساحة_الأرض_الإجمالية: العملية السحابية هنا = الناتج) "
                                        "نتيحة_معامل_البناء": "النتيجة هنا",
                                        "مساحة_البناء_الفعالة_للتجاري" :"مساحة_البناء_الفعالة_للدور_الأرضي + (مساحة_البناء_الفعالة_للمتكرر * (الطوابق_التجارية - 1))",
                                        "نطاق_حجم_الوحدات-التجارية": "'(اقترح مساحة من كذا إلى كذا)' ",
                                        "الوحدات_التجارية_المقترحة": "(مساحة_البناء_الفعالة_للتجاري / (متوسط حجم الوحدات التجارية))",
                                        "نتيجة_الوحدات_التجارية_المقترحة": "نتيجة الوحدات_التحارية_المقترحة هنا",
                                        "مساحة_البناء_الفعالة_للسكني" :"(نتيجة_مساحة_البناء_الفعالة - مساحة_البناء_الفعالة_للتجاري)",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "الوحدات_التجارية_المقترحة": "(مساحة_البناء_الفعالة_للتجاري / (متوسط حجم الوحدات التجارية))",
                                        "نتيجة_الوحدات_التجارية_المقترحة": "نتيجة الوحدات_التحارية_المقترحة هنا",
                                        "مساحة_البناء_الفعالة_للإداري" :"قم بحساب مساحة بناء الادوار اللإدارية ابتداءا من الدور الذي يلي الادوار التجارية مباشرةً",
