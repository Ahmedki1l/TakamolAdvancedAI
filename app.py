                            ...
                            
                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "(نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الإجمالية * الطوابق_المقترحة)",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "(نسبة_البناء_للملحق_العلوي * نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الإجمالية)",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "(نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الإجمالية * الطوابق_المقترحة)",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "(نسبة_البناء_للملحق_العلوي * نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الإجمالية)",
                                        "نتيجة_مساحة_البناء_الفعلية": "نسبة_البناء_للأدوار_المتكررة * نسبة_البناء_للملحق_العلوي * مساحة_الأرض_الإجمالية",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "(نسبة_البناء_للأدوار_المتكررة * مساحة_الفيلا * الطوابق_المقترحة)",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "(نسبة_البناء_للملحق_العلوي * نسبة_البناء_للأدوار_المتكررة * مساحة_الفيلا)",
                                        "نتيجة_مساحة_البناء_الفعالة": "(قم بحسابها هنا )",
                                        "معامل_البناء" : "(نتيجة_مساحة_البناء_الفعالة / نتيجة_مساحة_البناء_الفعالة: العملية الحسابية هنا = الناتج) "
                                        "نتيحة_معامل_البناء": "النتيجة هنا"
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "نسبة_البناء_للملحق_العلوي": "(استخدم الداتا المذكورة في الأسفل)",
                                        "الطوابق_المقترحة": "(اقترح عددا هنا)",
                                        "مساحة_البناء_الفعالة_للدور_الأرضي": "(نسبة_البناء_للدور_الأرضي * مساحة_الأرض_الفعالة_للبناء)",
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "(نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الفعالة_للبناء * الطوابق_المقترحة)",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "(نسبة_البناء_للملحق_العلوي * نسبة_البناء_للأدوار_المتكررة * مساحة_الأرض_الفعالة_للبناء)",
