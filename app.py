...
case_study_training_context_english = """
                                ...
                                Your response must be in json format and should look like this: 
                               {
                                    ...
                                    "Market_Strategy": {
                                        ...
                                        "Budget_Allocation": {
                                            "Total_Annual_Budget": "(Your response here)",
                                            "Digital_Marketing": "(Your response here)",
                                            "Traditional_Marketing": "(Your response here)",
                                            "Content_Creation": "(Your response here)",
                                            "Market_Research_and_Analytics": "(Your response here)"
                                        }
                                    },
                                    "Performance_Metrics": {
                               ...
                               أنت مستشار تسويق عقاري. 
                                ...
                                يجب أن تكون إجابتك بصيغة json ويجب أن تبدو هكذا: 
                                {
                                    ...
                                    "Market_Strategy": {
                                        "نظرة_عامة": "(ردك هنا).",
                                        "التسويق_الرقمي": {
                                            "إعلانات_Google": "(ردك هنا)",
                                            "إعلانات_وسائل_التواصل_الاجتماعي": "(ردك هنا)",
                                            "تسويق_المحتوى": "(ردك هنا)."
                                        },
                                        "التسويق_التقليدي": {
                                            "الإعلانات_الخارجية": "(ردك هنا).",
                                            "الوسائط_المطبوعة": "(ردك هنا)."
                                        },
                                        "تخصيص_الميزانية": {
                                            "إجمالي_الميزانية_السنوية": "(ردك هنا)",
                                            "التسويق_الرقمي": "(ردك هنا)",
                                            "التسويق_التقليدي": "(ردك هنا)",
                                            "إنشاء_المحتوى": "(ردك هنا)",
                                            "البحث_السوقي_والتحليلات": "(ردك هنا)"
                                        }
                                    },
                                    "Performance_Metrics": {
                                         "الحركة_المتوقعة": "(ردك هنا).",
                                        "معدل_التحويل": "(ردك هنا).",
                                        "تكلفة_اكتساب_العميل": "(ردك هنا)."
                                    },
                                    "ROI_Calculation": {
                                        "إسقاط_الإيرادات_السنوية": "(ردك هنا).",
                                        "تكلفة_التسويق_السنوية": "(ردك هنا)",
                                        "صافي_الربح": "(ردك هنا).",
                                        "نسبة_العائد_على_الاستثمار": "(ردك هنا)"
                                    },
                                    "Strategic_Insights": "(ردك هنا)",
                                    "Recommendations": "(ردك هنا)"
                                }
                            ...
                            
                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "تفاصيل_المشروع": {
                                        ...
                                        "تنظيمات_التخطيط": "يسمح ببناء حتى (اقترح عددا من الطوابق هنا) طوابق"
                                    },
                                    "معايير_التطوير": {
                                        "نسبة_البناء": "(اعمل بحث واختر النسبة المناسبة)",
                                        "مساحة_البناء_الفعالة": "مساحة_الأرض_الإجمالية * نسبة_البناء = 2000 * (نسبة البناء)",
                                    ...
                                    "توقعات_التمويل": {
                                        "تكلفة_شراء_الأرض": {
                                            "تكلفة_لكل_متر_مربع": "( اعمل سيرش على سعر الأرض الحالي ) ريال سعودي",
