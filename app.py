...
case_study_training_context_arabic = """
                               أنت مستشار تسويق عقاري. 
                                ...
                                يجب أن تكون إجابتك بصيغة json ويجب أن تبدو هكذا: 
                                {
                                    ...
                                    "Target_Audience": "(أعطني الفئة المستهدفة بطريقة احترافية و اماكن تواجدهم ومستواهم الاجتماعي)",
                                    "Pros": {
                                    ...
                                    "Market_Strategy": {
                                        "نظرة_عامة": "يدمج نهجنا قنوات التسويق الرقمية والتقليدية لتعظيم الرؤية والتفاعل مع المشروع. نهدف إلى تموضع هذا التطوير كالخيار الأول للمعيشة المستقبلية في الرياض.",
                                        "التسويق_الرقمي": {
                                            "إعلانات_Google": "تركيز على الكلمات المفتاحية عالية النية بتكلفة نقرة متوقعة 15 ريال سعودي لجذب حركة مرور مستهدفة.",
                                            "إعلانات_وسائل_التواصل_الاجتماعي": "استخدام الاستهداف الديموغرافي والنفسي على منصات مثل Facebook، Instagram، وLinkedIn للوصول إلى الملف الشخصي المثالي للعميل.",
                                            "تسويق_المحتوى": "إنشاء محتوى عالي الجودة، جذاب يسلط الضوء على الميزات الفريدة للشقق من خلال المدونات، الفيديوهات، والجولات الافتراضية التفاعلية."
                                        },
                                        "التسويق_التقليدي": {
                                            "الإعلانات_الخارجية": "لوحات إعلانية موضوعة استراتيجياً في المناطق ذات الحركة العالية داخل الرياض.",
                                            "الوسائط_المطبوعة": "إعلانات في الصحف الرائدة ومجلات العقارات، مستهدفة الأحياء الراقية."
                                        },
                                        "تخصيص_الميزانية": {
                                            "إجمالي_الميزانية_السنوية": "3,000,000 ريال سعودي",
                                            "التسويق_الرقمي": "1,800,000 ريال سعودي (60%)",
                                            "التسويق_التقليدي": "600,000 ريال سعودي (20%)",
                                            "إنشاء_المحتوى": "450,000 ريال سعودي (15%)",
                                            "البحث_السوقي_والتحليلات": "150,000 ريال سعودي (5%)"
                                        }
                                    },
                                    "Performance_Metrics": {
                                         "الحركة_المتوقعة": "50,000 زائر فريد شهرياً عبر الحملات الرقمية.",
                                        "معدل_التحويل": "5%، مما يعادل بيع 30 شقة سنوياً.",
                                        "تكلفة_اكتساب_العميل": "مقدر بـ 10,000 ريال سعودي لكل عملية بيع، بناءً على المصاريف التسويقية وأهداف المبيعات."
                                    },
                                    "ROI_Calculation": {
                                          "إسقاط_الإيرادات_السنوية": "36,000,000 ريال سعودي من مبيعات الشقق.",
                                        "تكلفة_التسويق_السنوية": "3,000,000 ريال سعودي",
                                        "صافي_الربح": "33,000,000 ريال سعودي بعد تكاليف التسويق.",
                                        "نسبة_العائد_على_الاستثمار": "1100% (صافي الربح مقسوماً على تكاليف التسويق)"
                                    },
