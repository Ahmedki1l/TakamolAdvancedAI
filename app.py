                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_لكل_متر_مربع": "(اكتبه بقيمة 9% منمساحة_الأرض_الإجمالية)",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "الطوابق_المقترحة": "6 طوابق",
                                        "مساحة_البناء_الفعلية_للدور_الأرضي": "3,500 * 0.65 = 2,275 متر مربع",
                                        "مساحة_البناء_الفعلية_للأدوار_المتكررة": "3,500 * 0.75 * 5 (عدد الأدوار المتكررة هو 5) = 13,125 متر مربع",
                                        "مساحة_البناء_الفعلية_للملحق_العلوي": "3,500 * 0.70 = 2,450 متر مربع",
                                        "نتيجة_مساحة_البناء_الفعلية": "2,275 + 13,125 + 2,450 = 17,850 متر مربع",
                                        "معامل_البناء": "17,850 / 3,500 = 5.1",
                                        "نتيجة_معامل_البناء": "5.1",
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "توقعات_الإيرادات_من_بيع_الوحدات_السكنية": {
                                        ...
                                        "توقعات_الإيرادات_من_إيجار_الوحدات_السكنية": {
                                            "الإيجار_السنوي_المتوقع_للسكني_لكل_متر_مربع": "(اكتبه بقيمة 9% من مساحة_الأرض_الإجمالية)",
                                            "الإيجار_السنوي_المتوقع_للتجاري_لكل_متر_مربع": "(اكتبه بقيمة 12% من مساحة_الأرض_الإجمالية)",
                                            "الإيجار_السنوي_الكلي_للسكني": "مجموع_المساحة_السكنية * سعر_البيع_السكني_لكل_متر_مربع: (مساحة بناء الأدوار السكنية فقط ( 4 )) * 600 = (3,500 * 0.75 * 4) * 600 = 6,300,000 ريال سعودي",
                                            "الإيجار_السنوي_الكلي_للتجاري": "مجموع_المساحة_التجارية * سعر_البيع_التجاري_لكل_متر_مربع: (الدور الأرضي + الدور الأول (2)) * 1000 = (2,275 + (3,500*0.75)) * 1000 = 4,900,000 ريال سعودي",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "توقعات_التمويل": {
                                        ...
                                        "توقعات_الإيرادات_من_الإيجار": {
                                            "الإيجار_السنوي_المتوقع_لكل_متر_مربع": "(اكتبه بقيمة 9% من مساحة_الأرض_الإجمالية)",
                                            "الإيجار_السنوي_الكلي": "مجموع_مساحة_البناء * الإيجار_الشهري_المتوقع_لكل_متر_مربع = ( قم بحساب العملية )",
                                            "نتيجة_الإيجار_السنوي_الكلي": "2160000 ريال سعودي",
                                            "النفقات_التشغيلية": "20% من الإيجار_السنوي_الكلي = 0.20 * 2160000",
                                            "نتيجة_النفقات_التشغيلية": "432000 ريال سعودي",
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        ...
                                        "معامل_البناء" : "(نتيجة_مساحة_البناء_الفعالة / مساحة الأرض: العملية السحابية هنا = الناتج) "
                                        "نتيحة_معامل_البناء": "النتيجة هنا"
                                        "نطاق_حجم_الفيلا": "'(اقترح مساحة من كذا إلى كذا)' ",
                                        "عدد_الفلل_المقترح": "قم بأخذ متوسط مساحة الوحدة و اقسم مساحة البناء الكلية على متوسط مساحة الفيلا",
...
investment_arabic_context_residential_compound = """
...

                            {
                                ...
                                "تقرير_تحليل_الاستثمار": {
                                    ...
                                    "معايير_التطوير": {
                                        "نسبة_البناء_الفعالة_على_الأرض":"60% (إذا لم يقدمها العميل)",
                                        "مساحة_الأرض_الفعالة_للبناء":"2000 * نسبة_البناء_الفعالة_على_الأرض: 2000 * 60% = 1200 متر مربع",
                                        "مساحة_كل_عمارة":"مساحة_الأرض_الفعالة_للبناء / عدد_العمارات_المقترحة : 1200 / 4 = 300 متر مربع",
                                        ...
                                        "نسبة_البناء_للملحق_العلوي": "(استخدم الداتا المذكورة في الأسفل)",
                                        "الطوابق_المقترحة": "(اقترح عددا هنا)",
                                        "مساحة_البناء_الفعالة_للدور_الأرضي": "(قم بحسابها هنا  مع مساحة_كل_عمارة)",
                                        "مساحة_البناء_الفعالة_للأدوار_المتكررة": "(قم بحسابها هنا مع مساحة_كل_عمارة مضروبة في عدد الطوابق المقترحة)",
                                        "مساحة_البناء_الفعالة_للملحق_العلوي": "(قم بحسابها هنا مع مساحة_كل_عمارة )",
                                        "نتيجة_مساحة_البناء_الفعالة": "(قم بحسابها هنا مع مساحة_كل_عمارة )",
                                        "معامل_البناء_للعمارة" : "(نتيجة_مساحة_البناء_الفعالة / مساحة_كل_عمارة: العملية السحابية هنا = الناتج) ",
                                        "نتيحة_معامل_البناء_للعمارة": "النتيجة هنا",
                                        "نطاق_حجم_العمارات": "'(اقترح مساحة من كذا إلى كذا)' ",
                                        "عدد_العمارات_المقترح": "قم بأخذ متوسط مساحة العمارة و اقسم مساحة البناء الكلية على متوسط مساحة الوحدة",
                                        "نتيجة_عدد_العمارات_المقترح": "نتيجة عدد_العمارات_المقترح هنا",
                                        "نطاق_حجم_الوحدات-السكنية": "'(اقترح مساحة من كذا إلى كذا)' ",
